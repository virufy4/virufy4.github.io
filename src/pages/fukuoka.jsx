    ...
    return (
      <Layout>
        ...
        <div className="px-6 lg:px-40 text-center">
          ...
          {/* Establishment Info */}
          <p className="mt-4 text-lg font-semibold">Virufy Fukuokaは、2024年12月に設立されました。</p>
          <p className="text-lg">一般社団法人として非営利組織であり、助成金や寄付金などを活用して、地域社会や貧しいコミュニティに貢献し、困っている人々に利益を還元することを目的としています。私たちの事業は、単に技術を提供するだけでなく、社会全体の健康増進と人々のウェルビーイングの向上を追求しています。</p>
        
          {/*Extended Info */}
          <p className="mt-4 text-lg">代表理事: 横田 文彦 </p>
          <p className="mt-4 text-lg">所在地: 福岡県内（詳細住所は公表を控えさせていただきます）</p>
        </div>
        ...
        <div className="px-6 lg:px-40 mt-10 mb-16 text-center">
          ...
          <p className="mt-2 text-lg">
            Eメール:{" "}
            <a href="mailto:yokota.fumihiko.785@m.kyushu-u.ac.jp" className="text-blue-600">
