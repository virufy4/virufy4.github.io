...
export default function Supporters() {
  ...
  return (
    <section>
      ...
      <section
        id="our-supporters"
        className="flex flex-col items-center py-10 md:px-14"
      >
        <div className="flex justify-between md:text-center  xs:px-4">
          <button
          ...
          <Link to="/oyw" className="md:hidden">
            <button className="bg-white text-gray-500 xs:text-2xl xs:mx-6 font-semibold ">
              {intl.formatMessage({
        ...
        {selectedTab === tabs.supporters && (
          <>
            <div className="grid grid-cols-5 gap-8 xs:grid-cols-2 xs:gap-12 items-center justify-center pt-8">
              <div
                style={{ flex: "0 1 20%" }}
                className="min-w-250 p-6 max-w-full"
              >
