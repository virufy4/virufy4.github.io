  ...
  engineering: {
    ...
    roles: [
...

      {
        ...
        responsabilities: [
          "Design and architecting application and cross-platform security requirements and technologies",
        ...
        requirements: [
          ...
          "Strong sense of responsibility and ability carry out tasks independently",
        ],
        desired_skills: [
  ...
  data: {
    ...
    roles: [
      ...
      },
      {
        ...
        responsabilities: [
          "Coordinate with international lawyers to translate documents to different languages and legal environments",
          "Work with executive management and infosec teams to define internal and external data security and privacy policies",
          "Take leadership and project management role to manage data privacy concerns of Virufy",
          "Review legal documents drafted by senior legal counsel such as Privacy Policy, Consent Form, Cookie Policy, Infosec Policy, and DPIA",
          "First responder to all external legal requests such as data deletion and data portability",
          "Research data privacy and protection questions raised from leadership",
        ],
        requirements: [
          "Academic studies or professional experience in information security or data privacy",
          "Organized, collaborative, detail-oriented, and tech savvy",
        ...
        desired_skills: [
          ...
          "Knowledge of or experience with Latin American culture",
        ],
        minimun_qualification: [],
        location: "Remote",
        time_commitment:
          "10-20 hours per week on a part-time volunteer basis, ideally over the next 3 months",
        url:
      ...
      },
      {
        ...
        responsabilities: [
          "Deeply research and identify state-of-the-art ML approaches for detecting COVID from coughs.",
          "Lead our team of Engineers that train, build, and deploy AI models into production.",
          "Produce clean code and APIs to facilitate understanding within the team.",
          "Collaborate with product management and leadership to deliver on expectations.",
          "Oversee data transformation infrastructure.",
          "Process and feature extract from a wide array of input data types.",
          "Identify transfer learning opportunities and auxiliary training datasets.",
          "Distill results into academic formats, e.g. research paper.",
        ],
        requirements: [
          "5-10 years of experience in engineering leadership or in a technical role.",
          "Passionate and committed to the Virufy mission, communicate effectively, and share learnings with the team.",
          "AWS infrastructure experience.",
          "Ensemble of classifier experience.",
          "Strong Python programming experience with toolkits such as Pandas, NumPy, Librosa.",
          "Extensive experience with machine learning frameworks like Tensorflow, PyTorch or other platforms (Scikit-learn, Keras..)",
          "Hands-on AI programming experience working on (ideally) enterprise products.",
          "Experience using AI for healthcare in clinical research studies and solving real-world problems.",
        ],
        desired_skills: [],
    ...
    roles: [
      {
        ...
        responsabilities: [
          "Define business funding needs and manage fundraising process.",
        ...
        minimun_qualification: [],
        location: "Remote",
        time_commitment: "10+ hours per week on a part-time volunteer basis",
        url:
          "https://docs.google.com/document/u/2/d/1DXWgFU5Jwm28RYRm_vHDkn-Pl32oOpFVvTNEedvPqzI",
      },
      {
  ...
  human_resources: {
    ...
    roles: [
      ...
      },
      {
        ...
        minimun_qualification: [],
        location: "Remote",
        time_commitment: "10-15 hours per week on a part-time volunteer basis",
        url:
